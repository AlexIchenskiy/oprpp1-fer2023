...
public class SimpleHashtable<K, V> implements Iterable<SimpleHashtable.TableEntry<K,V>> {
    ...
    public static void main(String[] args) {
        SimpleHashtable<String, String> sh1 = new SimpleHashtable<>();
        SimpleHashtable<String, String> sh = new SimpleHashtable<>(1);

        sh.put("hello", "world");
        System.out.println(sh.get("hello"));
        System.out.println(sh.remove("hello"));

        System.out.println(sh);

        sh.put("a", "b");
        System.out.println(sh.put("a", "c"));

        for (TableEntry<String, String> tableEntry : sh.toArray()) {
