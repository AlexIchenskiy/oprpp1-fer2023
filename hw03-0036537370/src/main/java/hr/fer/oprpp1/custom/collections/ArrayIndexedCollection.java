...
public class ArrayIndexedCollection<T> implements List<T> {
	 ...
	 */
	private static class ElementsGetterAIC<T> implements ElementsGetter<T> {

		/**
		 * Parent collection.
		 */
		private final ArrayIndexedCollection<T> aic;
		...
		private ElementsGetterAIC(ArrayIndexedCollection<T> aic) {
			if (aic == null) {
	...
	public ArrayIndexedCollection(Collection<T> other, int initialCapacity) {
		...
		this.elements = (T[]) new Object[Math.max(initialCapacity, other.size())];
		this.addAll(other);
	}
	...
	public void add (T value) {
		...
		if (this.size == this.elements.length) {
			...
			this.elements = (T[]) new Object[this.elements.length * MEMORY_MULTIPLIER];
	...
	public void insert (T value, int position) {
		...
		T[] temp = (T[]) new Object[this.elements.length];
