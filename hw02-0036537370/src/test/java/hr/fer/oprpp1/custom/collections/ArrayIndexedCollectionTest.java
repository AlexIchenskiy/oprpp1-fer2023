...
public class ArrayIndexedCollectionTest {
	...
	public void testConstructorWithCollectionCreateEmpty() {
		aic = new ArrayIndexedCollection(new ArrayIndexedCollection());
	...
	public void testConstructorWithCollectionAndCapacityCreateEmpty() {
		aic = new ArrayIndexedCollection(new ArrayIndexedCollection(), 8);
	...
	public void testAddAllSatisfying() {
		ArrayIndexedCollection aic2 = new ArrayIndexedCollection();
		for (int i = 1; i < 5; i++) {
			aic2.add(i);
		}
		aic.addAllSatisfying(aic2, new EvenIntegerTester());

		assertEquals(2, aic.size());
		assertEquals(2, aic.get(0));
		assertEquals(4, aic.get(1));
	}
